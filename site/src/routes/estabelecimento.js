...
router.delete("/estabelecimento/excluir", function (req, res) {
    estabelecimentoController.excluirEstabelecimento(req, res);
});

router.put("/estabelecimento/atualizar", function (req, res) {
...
router.post("/estabelecimento/cadastrar", function (req, res) {
